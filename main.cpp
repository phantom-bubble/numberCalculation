...
int main() {
    ...
    Rational r3 = r2 / Rational{"1"} - pow(r2, 2) / Rational{"2"} + pow(r2, 3) / Rational{"6"} - pow(r2, 4) / Rational{"24"};
    Rational r4 = pow(r2, 5) / Rational{"120"};
    ...
    std::cout << r4.to_ratio_string() << std::endl;
    return 0;
}
